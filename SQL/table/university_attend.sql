...
CREATE TABLE `attend` (
  ...
  `at_minterm` int NOT NULL DEFAULT '0',
  `at_finals` int NOT NULL DEFAULT '0',
...
INSERT INTO `attend` VALUES (1,0,0,0,0,2020110011,'20MSC001011'),(2,0,0,0,0,2020110013,'20MSC001011');
